...
export const Categories = ({ data }: Props) => {
    ...
    useEffect(() => {
        const calculateVisible = () => {
            ...
            const avaibaleWidth = containerWidth - viewAllWidth;
            ...
            for (const item of items) {
                ...
                if (totalWidth + width > avaibaleWidth) break;
        ...
        const resizeOnserver = new ResizeObserver(calculateVisible);
        resizeOnserver.observe(containerRef.current!);

        return () => resizeOnserver.disconnect();
    }, [data.length]);
